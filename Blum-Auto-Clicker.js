// ==UserScript==
// @name         Blum Auto Clicker (ARMIN-SOFT)
// @namespace    Violentmonkey Scripts
// @version      1.0.0
// @description  A Powerful Auto Clicker For Blum Website To Automate Clicking Process For Certain Buttons.
// @author       ARMIN-SOFT
// @match        https://telegram.blum.codes/*
// @exclude-match https://telegram.blum.codes/exclude/*
// @include      https://telegram.blum.codes/*
// @exclude      https://telegram.blum.codes/exclude/*
// @icon         https://cdn.prod.website-files.com/65b6a1a4a0e2af577bccce96/65ba99c1616e21b24009b86c_blum-256.png
// @downloadURL  https://raw.githubusercontent.com/armin-soft/Blum-Auto-Clicker/main/Blum-Auto-Clicker.js
// @updateURL    https://raw.githubusercontent.com/armin-soft/Blum-Auto-Clicker/main/Blum-Auto-Clicker.js
// @supportURL   https://github.com/armin-soft/Blum-Auto-Clicker/issues
// @homepageURL  https://github.com/armin-soft/Blum-Auto-Clicker
// @require      https://code.jquery.com/jquery-3.6.0.min.js
// @resource     BUTTON_ICON https://cdn.prod.website-files.com/65b6a1a4a0e2af577bccce96/65ba99c1616e21b24009b86c_blum-256.png
// @run-at       document-end
// @noframes     true
// @grant        none
// @inject-into  page
...
"https://raw.githubusercontent.com/armin-soft/refs/heads/main/answers/codes.json"
).then(res => {
if (!res.ok)
return {};
try {
...
menuTitle.textContent = 'Blum Auto Clicker (ARMIN-SOFT)';
...
'English:Percentage Probability Of Skipping A Flower<br>Persian: احتمال عبور از گل به درصد'],
['Min Freeze Hits', 'minIceHits', 'range', 1, 10, 1,
'English:Minimum Number Of Clicks Per Freeze<br>Persian: حداقل تعداد کلیک برای فریز'],
['Min Bomb Hits', 'minBombHits', 'range', 0, 10, 1,
'English:Minimum Number Of Clicks Per Nomb<br>Persian: حداقل تعداد کلیک برای بمب'],
['Min Delay (ms)', 'minDelayMs', 'range', 10, 10000, 10,
'English:Minimum Delay Between Clicks<br>Persian: حداقل تأخیر بین کلیک‌ ها'],
['Max Delay (ms)', 'maxDelayMs', 'range', 10, 10000, 10,
'English:Maximum Delay Between Clicks<br>Persian: حداکثر تأخیر بین کلیک‌ه ا'],
['Auto Click Play', 'autoClickPlay', 'checkbox', null, null, null,
'English:Automatically Start The Next Game At The End Of<br>Persian: به طور خودکار بازی بعدی را پس از پایان شروع کن'],
['Auto Claim Task', 'autoClaimTask', 'checkbox', null, null, null,
'English:Automatically Claim Completed Tasks<br>Persian: به طور خودکار وظایف تکمیل شده را قبول کن'],
['Auto Video Task', 'autoVideoTask', 'checkbox', null, null, null,
'English:Automatically Start The Next YouTube Video Then Verify<br>Persian: به طور خودکار ویدیو بعدی یوتیوب را پخش کن و سپس بررسی کن'],
['Auto Verify Code', 'autoVerifyCode', 'checkbox', null, null, null,
'English:Automatically Verify Started YouTube Task And (If Key Is Present)<br>Persian: به طور خودکار وظیفه شروع شده یوتیوب را تأیید کن (اگر کلید موجود باشد)']
];
...
githubButton.href = 'https://github.com/armin-soft';
...
telegramButton.href = 'https://t.me/ARMIN_SOFT';
...
donateButton.href = 'https://armin-soft.ir/';
...
background-image: url('https://raw.githubusercontent.com/armin-soft/refs/heads/main/images/green-background.png');
...
console.error("Blum Auto Clicker (ARMIN-SOFT) error:", e);
}
